		...
		<ul class="slides-container">
			<li class="text-left">
				...
				<div class="container">
					<div class="row">
						<div class="col-md-12">
							<h1 class="m-b-20"><strong>Welcome To <br> Quetta Restaurant</strong></h1>
				...
				<div class="container">
					<div class="row" style="color:white;">
						<div class="col-md-12">
							...
							<p class="m-b-40">Premium Restaurant & Banquet Services.  <br>
							Book your order now !</p>
							<p><a class="btn btn-lg btn-circle btn-outline-new-white" href="banquet.php">Order Now</a></p>
						</div>
					</div>
				</div>
			</li>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 text-center">
					<div class="inner-column">
						<h1>Welcome To <span>Quetta Restaurant & Banquet</span></h1>
						<p>Quetta Restauarant is a bench mark for Taste & Hygiene. We offer best quality food with premium services. Trending Takeaway service is also available here. Quetta Banquet is perfect location for all your functions. Now book your banquet online and celebrate the function offline!</p>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 ml-auto mr-auto text-center">
					...
					<span class="lead">Quetta Restaurant & Banquet</span>
				</div>
			</div>
		</div>
	</div>
					...
					<div id="reviews" class="carousel slide" data-ride="carousel">
						<div class="carousel-inner mt-4">
							...
							<div class="carousel-item text-center">
								...
								<h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Shah Zaib Sajid</strong></h5>
							...
							<div class="carousel-item text-center">
								...
								<p class="m-0 pt-3">Yajmaan Restaurant is our family restaurant. Such a great dishes and taste. Very fascinating management.</p>
							</div>
						</div>
