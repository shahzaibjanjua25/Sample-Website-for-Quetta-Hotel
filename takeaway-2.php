    ...
    <section class="second-sect">
		...
		<?php
		    function email($tid , $mail)
			{
                ...
                $to = $mail;
                $subject = 'Takeaway - Quetta Restaurant & Banquet';
                ...
                while($r = mysqli_fetch_array($query)){
                    ...
                    <html lang="en">
                      <head>
                        <meta charset="UTF-8" />
                        <title>Food Order Details : Quetta Restaurant</title>
                      </head>
                                            ...
                                            <tbody>
                                              <tr>
                                                <td style="padding-top: 24px; padding-bottom: 24px">
                                                  <img
                                                    src="https://QuettaRestraunt.com/images/takeaway.jpg"
                                                    ...
                                                    <tbody>
                                                      <tr>
                                                        ...
                                                        >
                                                          ...
                                                          please take delivery of your food order from Shahzaib
                                                    ...
                                                    <tbody>
                                                      ...
                                                      <tr>
                                                        ...
                                                        >
                                                          <span
                                                            style="font-weight: 600; color: #000000"
                                                            >Quetta Restaurant & Banquet</span
                                                          ><br />
                                                          Quetta Restaurant,Dheri Hassanabad 2, Rawalpindi Pakistan
                    
                                                          <br />
                                                          +92123345678, +92127645678the
                                                          <br />
                                                            <a href="mailto:RestaurantQuetta@gmail.com" target="_blank"><span
                                                              style="font-weight: 500; color: #9095a2; text-decoration: none;"
                                                              >RestaurantQuetta@gmail.com </span></a>
                                                        </td>
                                                      </tr>
                                                    </tbody>
                                                  </table>
                                              ...
                                              <tr>
                                                ...
                                                >
                                                  ...
                                                  <a
                                                    ...
                                                    href="mailto:RestaurantQuetta@gmail.com"
            ...
            $to = $mail;
            $subject = "Takeaway Confirmation - Quetta Restaurant & Banquet";
            $headers = "MIME-Version: 1.0" . "\r\n";
          	$headers .= "Content-type:text/html;charset=UTF-8" . "\r\n";
            
			$headers .= 'From: <takeaway_Shahzaib@QuettaRestraunt.com>' . "\r\n";
