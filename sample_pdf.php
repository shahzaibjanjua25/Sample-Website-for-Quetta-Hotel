...
<head>
  ...
  src: url(https://thewebmate.in/Shahzaib-01/pdf_Shahzaib/pdf_takeaway/SourceSansPro-Regular.ttf);
}
...
<body>
    <header class="clearfix">
        <div id="logo">
            <img src="https://thewebmate.in/Shahzaib-01/pdf_Shahzaib/pdf_takeaway/logo-y.jpg">
        </div>
        <div id="company">
            <h2 class="name">Quetta Restaurant & Banquet</h2>
            <div>Rawalpindi, Pakistan<br>Rawalpindi Pakistan</div>
            <div><a href="tel:+92123345678">+92123345678, </a><a href="tel:+92127645678">+92127645678</a></div>
            <div><a href="QuettaRestraunt.com">QuettaRestraunt.com</a></div>
        </div>
    </header>
    <main>
        <div id="details" class="clearfix">
            <div id="client">
                ...
                <h2 class="name">Moin Ali</h2>
                <div class="address">B/201, High Rise Tower, Paldi</div>
                <div class="email"><a href="mailto:moinali@gmail.com">moinali@gmail.com</a></div>
            </div>
            <div id="invoice">
                <h1>Food Takeaway</h1>
        ...
        <table border="0" cellspacing="0" cellpadding="0">
            ...
            <tbody>
                <tr>
                    ...
                    <td class="unit">PKR 90</td>
                    <td class="qty">2</td>
                    <td class="total">PKR 180</td>
                </tr>
                <tr>
                    <td class="no">02</td>
                    <td class="desc">
                    ...
                    <td class="unit">PKR 40</td>
                    <td class="qty">3</td>
                    <td class="total">PKR 120</td>
                </tr>
                <tr>
                    <td class="no">03</td>
                    <td class="desc">
                    ...
                    <td class="unit">PKR 200</td>
                    <td class="qty">1</td>
                    <td class="total">PKR 200</td>
                </tr>
            </tbody>
            <tfoot>
                <tr>
