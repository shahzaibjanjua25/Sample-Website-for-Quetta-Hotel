...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Feedback Form - Quetta Restaurant and Banquet</title>
    ...
    <style>
        ...
        .terrible{ background-image: url('https://QuettaRestraunt.com/images/1star.jpg'); }
        .moderate{ background-image: url('https://QuettaRestraunt.com/images/2star.jpg'); }  
        .bad{ background-image: url('https://QuettaRestraunt.com/images/3star.jpg'); }
        .good{ background-image: url('https://QuettaRestraunt.com/images/4star.jpg'); }
        .excellent{ background-image: url('https://QuettaRestraunt.com/images/5star.jpg'); }
				...
				<div class="col-lg-12">
					<form id="contactForm" method="post" action="#">
						<div class="row">
							...
							<div class="col-md-12 p-2">
								<div class="form-group">
									<span class="field-title" style="font-size:26px"> Your Review for Quetta Restaurant & Banquet</span>
	...
	<footer class="footer-area bg-f">
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">Rights Reserved. &copy; 2020 <a href="./index.html">&nbsp;Quetta Restaurant & Banquet</a> <br>Managed By 'ArtiFatto ' Group</p>
					</div>
				</div>
			</div>
		</div>
