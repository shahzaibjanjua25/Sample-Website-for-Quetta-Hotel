                                                                                                                            ...
                                                                                                                            <tbody>
                                                                                                                                <tr style="margin: 0;">
                                                                                                                                    <td align="center" colspan="2" style="margin: 0; vertical-align: top;">
                                                                                                                                        ...
                                                                                                                                        <div class="text3" style="color: #292a2a; font-family: 'Avenir Next', 'Avenir', open sans, Helvetica; font-size: 20px; line-height: 1.6; margin: 0; padding: 0;">
                                                                                                                                            Order
                                                                                                                                            Details
                                                                                                                                            for
                                                                                                                                            <b>
                                                                                                                                        <!-- php-->
                                                                                                                                        <?php    
                                                                                                                                            $exec = mysqli_query($con,"select * from banquet_booking_user where Bbid = 86"); 
                                                                                                                        ...
                                                                                                                        <table cellpadding="0" cellspacing="0" style="font-size: 14px; margin: 0px auto;border-collapse: ;" width="100%">
                                                                                                                            <tbody>
                                                                                                                                ...
                                                                                                                                <tr style="margin: 0;border-radius: 20px;border: 0px solid rgba(0, 0, 0, 0.212);height: 20px;width: 100%;background-color: #fde1ff;">
                                                                                                                                    ...
                                                                                                                                    <td align="right" style="margin: 0; vertical-align: top;border-top-right-radius: 10px;padding-right: 20px; border-bottom-right-radius: 10px;">
                                                                                                                                        PKR
                                                                                                                                        <?php echo ($r['total_bill'] - ($r1['price'] * $r['no_of_slots'])); ?>
                                                                                                                                    </td>
                                                                                            ...
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr style="margin: 0;">
                                                                                                    <td class="text4" style="color: #292a2a; font-family: 'AvenirNext-DemiBold', 'Avenir', open sans, Helvetica; font-size: 18px; font-weight: bold; line-height: 1.6; margin: 0; padding: 0; vertical-align: top;">
                                                                                                        Total : PKR <?php echo $r['total_bill']; ?>
                                                                                                    </td>
                                                                                                </tr>
                                                                                            ...
                                                                                            <tbody>
                                                                                                <tr style="margin: 0;">
                                                                                                    <td align="left" colspan="2" style="margin: 0; vertical-align: top;">
                                                                                                        <div class="text3" style="color: #292a2a; font-family: 'Avenir Next', 'Avenir', open sans, Helvetica; font-size: 14px; line-height: 1.6; margin: 0; padding: 0;">
                                                                                                            Congratulations!
                                                                                                            <b><?php echo $r['name']; ?></b>,
                                                                                                            your
            ...
            <tbody>
                <tr class="footer" style="margin: 0;">
                    <td align="center" style="margin: 0; text-align: center; vertical-align: top;">
                        <table cellpadding="0" cellspacing="0" class="content-wrapper" style="margin: 0; padding: 0px 45px; font-family: 'Avenir Next', 'Avenir', 'open sans', 'Helvetica';font-size: 10px;line-height: 1.6;color: #9fa0a4; text-align: center;" width="100%">
                            <tbody>
                                <tr style="margin: 0;">
                                ...
                                <tr>
                                    <td style="font-family: 'Avenir Next', 'Avenir', 'open sans', 'Helvetica';">Sent with
                                        Care from Quetta Restaurant</td>
                                </tr>
                                <tr>
                                    <td style="font-family: 'Avenir Next', 'Avenir', 'open sans', 'Helvetica';">Quetta Restaurant,Dheri Hassanabad 2, Rawalpindi Pakistan</td>
                                    <td height="28" style="height: 38px; margin: 0;vertical-align: top;">&nbsp;</td>
                                </tr>

                                <tr>
                                    <a href="tel:+92123345678" target="_blank"><td style="font-family: 'Avenir Next', 'Avenir', 'open sans', 'Helvetica'; color:#b13476;">Any Queries? Ring your phone to : <br>+92123345678, +92127645678</a></td>
                                    <td height="28" style="height: 38px; margin: 0;vertical-align: top;">&nbsp;</td>


                                </tr>
                                <tr>
                                    <a href="https://QuettaRestraunt.com" target="_blank"><td style="font-family: 'Avenir Next', 'Avenir', 'open sans', 'Helvetica'; color:#b13476;">Visit our Website : QuettaRestraunt.com</a></td>
                                </tr>
                                <tr height="15" style="height: 15px">
                                </tr>
