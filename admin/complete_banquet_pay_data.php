<?php
    ...
    function email($email,$id){
        require 'db.php';
        $to = $email;
        $subject = 'Banquet Payment Complete - Shahzaibn Restaurant & Banquet';
        $q = mysqli_query($con,"select * from banquet_booking_user where Bbid = $id");
                                                                                    ...
                                                                                    <td align="center" style="margin: 0; vertical-align: top;">
                                                                                        <table style="background-color: #feffea; border-top: 1px solid #d8d8d8; margin: 0; text-align: center; width: 60%;" width="60%">
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr style="margin: 0;">
                                                                                                    <td class="text4" style="color: #292a2a; font-family:  "AvenirNext-DemiBold", "Avenir", open sans, Helvetica; font-size: 18px; font-weight: bold; line-height: 1.6; margin: 0; padding: 0; vertical-align: top;">
                                                                                                        Remaining Payment : PKR '.number_format($r['remaining_payment']).'
                                                                                                    </td>
                                                                                                </tr>
    ...
    function feedback($to){
        $to = $to;
		$subject = "Feedback - Quetta Restaurant & Banquet";
                                    ...
                                    <tr>
                                      ...
                                      >
                                          ...
                                          <img
                                            align="left"
                                            alt=""
                                            src="https://thewebmate.in/Shahzaib-01/emails/feedback_banner.jpg"
                                            width="564"
                                            style="
                                              border-radius: 20px;
                                              max-width: 1437px;
                                    ...
                                    <tr>
                                      ...
                                      >
                                        <a
                                          ...
                                          href="QuettaRestraunt.com/feedback"
                                          target="_blank"
                                          style="
                                            font-weight: bold;
                                            letter-spacing: 0px;
                                          ...
                                          <em
                                            ><a
                                              ...
                                              ><img
                                                ...
                                                height="33"
                                                src="https://thewebmate.in/Shahzaib-01/emails/logo-y.jpg"
                                                style="
                                                  border: 0px;
                                                  width: 132px;
                                                  height: 33px;
...
';
 $headers = "MIME-Version: 1.0" . "\r\n";
			...
			$headers .= 'From: <feedback@QuettaRestraunt.com>' . "\r\n";
			$headers .= 'Cc: <RestaurantQuetta@gmail.com>' . "\r\n";
                                                                                    ...
                                                                                    <td align="center" style="margin: 0; vertical-align: top;">
                                                                                        <table style="background-color: #feffea; border-top: 1px solid #d8d8d8; margin: 0; text-align: center; width: 60%;" width="60%">
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr style="margin: 0;">
                                                                                                    <td class="text4" style="color: #292a2a; font-family:  "AvenirNext-DemiBold", "Avenir", open sans, Helvetica; font-size: 18px; font-weight: bold; line-height: 1.6; margin: 0; padding: 0; vertical-align: top;">
                                                                                                        Remaining : PKR '.number_format($remain).'
                                                                                                    </td>
                                                                                                </tr>
                                                                                                <tr height="10" style="height: 10px; margin: 0;">
                                                                                                </tr>
