...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
    <title>Quetta Restaurant and Banquet</title>
			...
			<div class="row">
				...
				<div class="col-md-4">
					...
					<div class="overflow-hidden">
						<h4>Location</h4>
						<p class="lead">
							Quetta Restaurant, Rawalpindi Pakistan
						</p>
					</div>
				</div>
			</div>
	...
	<footer class="footer-area bg-f">
		<div class="container">
			<div class="row">
				<div class="col-lg-4 col-md-6">
					...
					<span style="padding:8px">'ArtiFatto ' Group </span>
					</p>
				...
				<div class="col-lg-4 col-md-6">
					...
					<p class="lead">Quetta Restaurant,Rawalpindi, Pakistan</p>
					<p class="lead"><a href="tel:8469000683">84690 00683,</a> &nbsp;<a href="tel:8128141047">81281 41047</a></p>
					<p><a href="mailto:RestaurantQuetta@gmail.com"> RestaurantQuetta@gmail.com</a></p>
				</div>
				<div class="col-lg-4 col-md-6">
					<h3>Opening hours</h3>
		...
		<div class="copyright">
			<div class="container">
				<div class="row">
					<div class="col-lg-12">
						<p class="company-name">Rights Reserved. &copy; 2020 <a href="./index.php">&nbsp;Quetta Restaurant & Banquet</a> <br>Managed By 'ArtiFatto ' Group<br>Developed By <a href="https://thewebmate.in" target="_blank">Webmate Web Services</a></p>
					</div>
				</div>
			</div>
		</div>
...
<?php 
    ...
    function email($email , $bbid, $menu){
            require 'db.php';            
            $to = $email;
			$subject = "Banquet Booking Confirmation - Quetta Restaurant & Banquet";
    ...
    <body style="background-color: #f0f0f1; font-family: "Avenir Next", "Avenir", open sans, Helvetica; margin: 0; padding: 0;">
                                                                                            ...
                                                                                            <tbody>
                                                                                                ...
                                                                                                <tr style="margin: 0;">
                                                                                                    <td class="text4" style="color: #292a2a; font-family:  "AvenirNext-DemiBold", "Avenir", open sans, Helvetica; font-size: 18px; font-weight: bold; line-height: 1.6; margin: 0; padding: 0; vertical-align: top;">
                                                                                                        Total (Inclusive of Taxes):  PKR '.number_format($total).'
                                                                                                    </td>
                                                                                                </tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" style="margin: 0;" width="100%">
                    ...
                    <td align="center" style="margin: 0; text-align: center; vertical-align: top;">
                        <table cellpadding="0" cellspacing="0" class="content-wrapper" style="margin: 0; padding: 0px 45px; font-family:  "AvenirNext-DemiBold", "Avenir", "open sans", "Helvetica";font-size: 10px;line-height: 1.6;color: #9fa0a4; text-align: center;" width="100%">
                            <tbody>
                                ...
                                <tr>
                                    <td style="font-family: "AvenirNext-DemiBold", "Avenir", "open sans", "Helvetica";">Quetta Restaurant,Dheri Hassanabad 2, Rawalpindi Pakistan</td>
                                    <td height="28" style="height: 38px; margin: 0;vertical-align: top;">&nbsp;</td>
                                </tr>

                                <tr>
                                    <a href="tel:+92123345678" target="_blank"><td style="font-family: "AvenirNext-DemiBold", "Avenir", "open sans", "Helvetica"; color:#b13476;">Any Queries? Ring your phone to : <br>+92123345678, +92127645678</a></td>
                                    <td height="28" style="height: 38px; margin: 0;vertical-align: top;">&nbsp;</td>


                                </tr>
                                <tr>
                                    <a href="https://QuettaRestraunt.com" target="_blank"><td style="font-family: "AvenirNext-DemiBold", "Avenir", "open sans", "Helvetica"; color:#b13476;">Visit our Website : QuettaRestraunt.com</a></td>
                                </tr>
                                <tr height="15" style="height: 15px">
                                </tr>
			...
			$headers .= 'From: <banquet_Shahzaib@QuettaRestraunt.com>' . "\r\n";
			$headers .= 'Cc: <RestaurantQuetta@gmail.com>' . "\r\n";
